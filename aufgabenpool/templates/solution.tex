...
% für Umlaute und Sonderzeichen Ausgabe
\usepackage{ngerman}	
% neue deutsche Rechtschreibung und Silbentrennung
\usepackage{eurosym}
% für ein vernünftiges Euro-Symbol. Nach ngerman setzen, damit € rechts steht.
...
%% new environments
\newenvironment{question}{\item \textbf{Aufgabe}\newline}{}
...
%% headings
\markboth{\textnormal{\bf \large Aufgabenblatt: \myID}}%
{\textnormal{\bf \large Aufgabenblatt: \myID}}
...
\thispagestyle{empty}
{\sf
\textbf{\LARGE{Digitaler Aufgabenpool}}

\textbf{\large{Datum \myDate \hfill Aufgabenblatt \myID}}

\vspace*{2cm}

\begin{tabular}{p{14cm}}
\textbf{Name:} \hrule \\[1.5cm]
\textbf{Studenten ID:} \hrule \\[1.5cm]
